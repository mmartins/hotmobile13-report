...
discussion. In the keynote, %(\S\ref{sec:keynote}),
...
%a solution that, in turn, brought its own loading issues.
Within 
%the mobile 
...
%of energy\slash network
%use so that user could make appropriate decisions.
to support decision making. %One potential technique for 
